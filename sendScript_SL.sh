...
day=${1}
mix=no
submmissionbase=/lustre/hebe/hades/user/${user}/sub/GE/${day}/
submissiondir=${submmissionbase}/gen2/
 nFilesPerJob=50 # for SIM or EXP extract
    jobscript=${submissiondir}/jobScript_SL.sh                        # exec script (full path, call without dot, set it executable!)
    outputdir=/lustre/hebe/hades/user/${user}/mar19/gee/day${day}_gen2/   # outputdir for files AND logFiles
...
par2=${submissiondir}/emc_diphoton_ana                               # optional par2 : executable
